...
function AdminPage() {
    ...
    return ( <
            ...
            id = "fullName"
            className = " bg-gray-300 border rounded-md px-2 text-black border-solid border-blue-800" / >
            ...
            onChange = {
                (e) => setExperienceYear(e.target.value) }
            id = "experienceYear"
            className = " bg-gray-300 border rounded-md px-2 text-black border-solid border-blue-800" / >
            ...
            <
            button type = "submit"
            className = "px-4 bg-blue-700 rounded-sm" > Save < /button> <
            /form>
                    ...
                    ul className = " flex flex-row px-1 space-x-1 items-center overflow-x-auto overflow-y-hidden" > {
                        images.map(
                            (item, index) => ( <
                                ...
                                alt = { item.title }
                                className = "w-16 h-16  shadow-md rounded-md pb-1 border border-solid border-gray-500" / >
                                <
                                /li>)
                            )
                        } <
