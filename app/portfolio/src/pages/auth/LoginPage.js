...
useEffect(()=>{
  ...
  return (
   ...
   <input 
    ...
    class={`py-3 px-4 block w-full ${signInData.error==='Wrong password'?
  ...
  {signInData.error==="Network Error"&&<p className="text-red-500 font-normal text-sm">Something went wrong, try again</p>}
   <div class="flex mt-4">
